...
// export const getSingleBook=async(reqHeader,id)=>{
...
export const getAllJobApplications=async(reqHeader)=>{
  return await commonApi('get',BaseUrl+'/getAllJobApplications',"",reqHeader)
}
...
export const getSoldBooks=async(reqHeader)=>{
  return await commonApi('get',BaseUrl+'/getSoldBookByUser',"",reqHeader)
}