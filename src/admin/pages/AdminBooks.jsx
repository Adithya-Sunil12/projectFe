      ...
      <div className="grid grid-cols-[2fr_5fr]">
        ...
        <div>
          ...
          {showBooks && (
            <div>
              {" "}
                <input onChange={(e)=>setSearchKey(e.target.value)} type="text"  className="bg-black text-white p-1 rounded-xl " placeholder="Search"/>
                ...
                {allBooks?.length > 0 && (
                  <div className="grid grid-cols-3 mt-5">
                    {allBooks.map((eachBook) => (
                      <div>
                        <div class="h-[80 vh] w-[40vh] bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-300 dark:border-gray-700">
                          <a href="#">
                            <img
                              class="rounded-t-lg"
              ...
              {userData?.length > 0 && (
                <div className="grid grid-cols-4 gap-10 mt-10">
                  {userData?.map((eachUser) => (
                    <div className="border p-5 bg-amber-200">
